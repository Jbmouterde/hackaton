...
//   });
document.querySelector(".blankSection")(function() {
  var width,
    height,
    largeHeader,
    canvas,
  ...
  function Triangle() {
    ...
    this.draw = function() {
      ...
      ctx.beginPath();
      ctx.moveTo(
        _this.coords[0].x + _this.pos.x,
        _this.coords[0].y + _this.pos.y
      );
      ctx.lineTo(
        _this.coords[1].x + _this.pos.x,
        _this.coords[1].y + _this.pos.y
      );
      ctx.lineTo(
        _this.coords[2].x + _this.pos.x,
        _this.coords[2].y + _this.pos.y
      );
      ctx.closePath();
